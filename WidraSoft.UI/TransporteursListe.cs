...
{
    public partial class TransporteursListe : Form
    {
        string vg_filter = "";
        public TransporteursListe(string filter)
        {
            InitializeComponent();
        ...
        private void TransporteursListe_Load(object sender, EventArgs e)
        {
            this.CenterToScreen();
        ...
        private void Bind_Dgv()
        {
            ...
            DgvList.DataSource = transporteur.List(vg_filter);
        ...
        private void Localize_Dgv(string lang)
        {
            if (lang == "fr")
            {
                DgvList.Columns["LICENCE"].HeaderText = "LICENCE";
            ...
            if (lang == "en")
            {
                DgvList.Columns["LICENCE"].HeaderText = "LICENSE";
            ...
            if (lang == "es")
            {
                DgvList.Columns["LICENCE"].HeaderText = "LICENCIA";
        ...
        {
            DgvList.Focus();
            Form form = new TransporteurDetail("Edit", Common_functions.GetDatagridViewSelectedId(DgvList));
            form.Show();
        }

        private void ajouterToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form form = new TransporteurDetail("Add", 0);
            form.Show();
        }
        ...
        {
            Transporteur transporteur = new Transporteur();
            DgvList.DataSource = transporteur.SearchBox(txtSearchBox.Text);
        }
        ...
        private void cbLang_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbLang.Text == "FR")
            {
                ...
                language_Manager.ChangeLanguage("fr", this, typeof(TransporteursListe));
                Localize_Dgv("fr");
            }
            ...
            if (cbLang.Text == "EN")
            {
                ...
                Spain_flag.Visible = false;
                Language_Manager language_Manager = new Language_Manager();
                language_Manager.ChangeLanguage("en", this, typeof(TransporteursListe));
                Localize_Dgv("en");
            }
            ...
            if (cbLang.Text == "ES")
            {
                ...
                Language_Manager language_Manager = new Language_Manager();
                language_Manager.ChangeLanguage("es", this, typeof(TransporteursListe));
                Localize_Dgv("es");
            }
        }
